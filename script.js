    ...
    import {
      ...
      SKIN_COLORS, SKIN_COLOR_WEIGHTS, SKIN_COLOR_NAMES_DE, LOOTBOX_PRICE, MAX_SKINS,
    ...
    (() => {
      ...
      function performProgressReset(){
        ...
        state.projects = {};
        state.dice = { owned: ["d4"], active: "d4", casinoActive: "d4" };
        // state.diceSkins bleibt BEWUSST unberührt: Skins sind permanent —
        // weder der Progress-Reset noch /reset (resetTodayProgress) löschen sie.
        if(state.flow){
      ...
      function renderSkinCollection(){
        ...
        const visible = owned
          ...
          .slice()
          .sort((a, b) => (b.pulledAt || 0) - (a.pulledAt || 0)); // neueste zuerst
