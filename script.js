    (() => {
      ...
      function setupSaveLifecycleHooks(){
        ...
        window.addEventListener("beforeunload", flushSyncOnUnload);
      ...
      function renderTimerControls(){
        ...
        setText(dom.startBtn, "startBtn", computeStartButtonText());
        setText(dom.compactToggle, "compactToggle", computeCompactToggleText());
